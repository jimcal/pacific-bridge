  ...
  "zh-Hant": {
    ...
    "section-8": {
      ...
      paragraphs: [
        ...
        "帶領工程團隊做行銷與營運資料系統，把行銷和客戶關係資料與流程串起來，讓線索與客戶資訊更準、更快流到正確的人和流程。",
        "軟體與資料工程背景的工程主管，長期做高流量產品與資料平台，包含大型即時資料處理系統；近年在電商/金融資料領域帶團隊，把產品、資料與商業流程做成可規模化的系統。",
        "任務是提供投資人新創/私募公司的可靠資料，並把未上市公司的資料提供評比，讓投資決策更快也更可驗證。",
